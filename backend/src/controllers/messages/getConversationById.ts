...
const getConversationById = async (
  ...
  try {
    ...
    const conversation = await messagesDb.getConversationById(req.body.conversation_id)

    // get lthe full list of messaged for the conversation
    const messages = await messagesDb.getWholeConversationById(req.body.conversation_id)
