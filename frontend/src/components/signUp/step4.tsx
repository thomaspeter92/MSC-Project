...
const Step4 = ({ formik }: Props) => {
  ...
  return (
    <div>
      ...
      <label
        htmlFor="imgUpload"
        className="flex items-center font-semibold w-fit gap-2 bg-rose-500 text-white py-2 px-4 rounded"
      >
        <Icon size={20} />
        Upload Image
      </label>
      <div className="w-full h-[200px] my-5 relative bg-rose-100 rounded">
        {image ? (
          <img
            ...
            alt="Uploaded"
            className="object-contain absolute h-full w-full object-center"
          />
        ) : (
